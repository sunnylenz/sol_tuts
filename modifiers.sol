// 1. Create a new function, increaseX in the contract. The function should 
//take an input parameter of type uint and increase the value of the variable x 
//by the value of the input parameter.
